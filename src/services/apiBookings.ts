import type {
  ...
  GetApiBooking,
  GetApiBookings,
  GetApiBookingsAfterDate,
  GetApiBookingStaysAfterDate,
...
export async function getBookings({
  ...
  return { data: data as unknown as GetApiBookings[], count };
}
...
export async function getBookingsAfterDate(
  ...
  return data as GetApiBookingsAfterDate[];
}
...
export async function getStaysAfterDate(
  ...
  return data as GetApiBookingStaysAfterDate[];
}
...
> {
  ...
  return data as GetApiBookingStaysTodayActivity[];
}
